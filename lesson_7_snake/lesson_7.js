    ...
    validate(){
        ...
        if (this.getRowsCount() < 10 || this.getRowsCount() > 30) {
          ...
          if (this.getWallTimer()<1 || this.getWallTimer()>100){
            result.isValid = false;
            result.errors.push('Неверные настройки, значение wallTimer должно быть в диапазоне [1000, 100000].'); 
          }
          ...
          if (this.getInitialGameScore() !== 0){
            result.isValid = false;
            result.errors.push('Неверные настройки, значение gameScore должно быть в диапазоне [0, 0].');
          }
